...
enum class ItemCategory(val slug: String, val apiNames: Set<String>) {
    ...
    HELD_ITEMS("held-items", setOf("held-items", "choice", "bad-held-items", "type-enhancement", "type-protection", "scarves", "jewels", "plates", "memories", "effort-training")),
    MEGA_STONES("mega-stones", setOf("mega-stones", "z-crystals", "dynamax-crystals")),
    KEY_ITEMS("key-items", setOf("key-items", "plot-advancement", "gameplay", "event-items", "dex-completion", "spelunking", "data-cards")),
