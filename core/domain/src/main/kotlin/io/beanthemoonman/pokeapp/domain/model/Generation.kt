...
object Generations {
    val all: List<Generation> = listOf(
        ...
        Generation(3, "III", "Hoenn", 386, listOf("Ruby", "Sapphire", "Emerald", "FireRed", "LeafGreen")),
        Generation(4, "IV", "Sinnoh", 493, listOf("Diamond", "Pearl", "Platinum", "HeartGold", "SoulSilver")),
        ...
        Generation(7, "VII", "Alola", 809, listOf("Sun", "Moon", "Ultra Sun", "Ultra Moon", "Let's Go")),
        Generation(8, "VIII", "Galar", 905, listOf("Sword", "Shield", "Brilliant Diamond", "Shining Pearl", "Legends: Arceus")),
